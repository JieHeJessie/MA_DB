...
urlpatterns = [
   ...
   url(r'^MA_DB/import_quote$',views.import_quote,name='import_quote'),
   url(r'^MA_DB/import_invoice$',views.import_invoice,name='import_invoice'),
   url(r'^MA_DB/read_project$',views.read_project,name='read_project'),
   url(r'^MA_DB/read_quote$',views.read_quote,name='read_quote'),
   url(r'^MA_DB/read_invoice$',views.read_invoice,name='read_invoice'),
